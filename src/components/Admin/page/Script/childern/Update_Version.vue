            ...
            <div class="flex flex-col gap-4 mt-5">
                <div>
                    ...
                    <textarea placeholder="Enter Description"
                        ...
                        v-model="Changelogs[0].description"></textarea>
                    <div class="mt-3">
                    ...
                    <div class="w-full flex justify-end items-center mt-2 gap-4">
                        <button type="submit"
                            class="w-[100px] h-[35px] bg-rose-400 text-white rounded-lg my-5 hover:bg-rose-700 duration-300" @click="(
                            Changelogs[0].version = null, Changelogs[0].description = null, download = null )">ยกเลิก</button>
                        <button type="submit"
                            class="w-[100px] h-[35px] bg-[#3d7fa1] text-white rounded-lg my-5 hover:bg-secondary duration-300" @click="updateVersion">ยันยืน</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async updateVersion() {
            if(!this.Changelogs[0].version || !this.Changelogs[0].description || !this.download) {
            ...
            const api = `${config.EndPoint}/script_version/${this.$route.params.id}`;
